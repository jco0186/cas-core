...
public final class LogoutController extends AbstractController {
    ...
    protected ModelAndView handleRequestInternal(
        ...
        if (ticketGrantingTicketId != null) {
            System.out.println("11111"+this.centralAuthenticationService);
            System.out.println("22222"+this.ticketGrantingTicketCookieGenerator);
            System.out.println("33333"+this.ticketGrantingTicketCookieGenerator);
